use crate::{
    get_metadata_mut, get_mode, insert_metadata, insert_storage, link_tensor_to_storage, next_storage_id, Tensor,
    TensorId, TensorMetadata, TensorStorage, TensorUpdateStatus,
};
use maidenx_core::{
    device::Device,
    dtype::DType,
