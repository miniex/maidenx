...
mod tests {
    ...
    #[test]
    fn test_tanh_backward() -> NnResult<()> {
        let device = Device::Cpu;
    ...
    #[test]
    fn test_tanh_chain_backward() -> NnResult<()> {
        let device = Device::Cpu;
    ...
    #[test]
    #[cfg(feature = "cuda")]
    fn test_cuda_tanh_backward() -> NnResult<()> {
        let device = Device::cuda(0);
