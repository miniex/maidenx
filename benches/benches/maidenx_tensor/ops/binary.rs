...
pub fn basic(criterion: &mut Criterion) {
    ...
    let operations: Vec<(
        ...
        ("add", Box::new(|v| v), Box::new(|v| v.iter().map(|x| x + 1.0).collect()), 
            Box::new(|x, y| x.add(y))),
        ("sub", Box::new(|v| v), Box::new(|v| v.iter().map(|x| x + 1.0).collect()), 
            Box::new(|x, y| x.sub(y))),
        ("mul", Box::new(|v| v), Box::new(|v| v.iter().map(|x| x + 1.0).collect()), 
            Box::new(|x, y| x.mul(y))),
        ("div", Box::new(|v| v.iter().map(|x| x + 2.0).collect()), 
            Box::new(|v| v.iter().map(|x| x + 1.0).collect()), 
            Box::new(|x, y| x.div(y))),

        // Logical operations
        ("logical_and", Box::new(|v| v), Box::new(|v| v.iter().map(|x| x + 1.0).collect()), 
            Box::new(|x, y| x.logical_and(y))),
        ("logical_or", Box::new(|v| v), Box::new(|v| v.iter().map(|x| x + 1.0).collect()), 
            Box::new(|x, y| x.logical_or(y))),
        ("logical_xor", Box::new(|v| v), Box::new(|v| v.iter().map(|x| x + 1.0).collect()), 
            Box::new(|x, y| x.logical_xor(y))),

        // Comparison operations
        ("eq", Box::new(|v| v), Box::new(|v| v.iter().map(|x| x + 1.0).collect()), 
            Box::new(|x, y| x.eq(y))),
        ("ne", Box::new(|v| v), Box::new(|v| v.iter().map(|x| x + 1.0).collect()), 
            Box::new(|x, y| x.ne(y))),
        ("lt", Box::new(|v| v), Box::new(|v| v.iter().map(|x| x + 1.0).collect()), 
            Box::new(|x, y| x.lt(y))),
        ("le", Box::new(|v| v), Box::new(|v| v.iter().map(|x| x + 1.0).collect()), 
            Box::new(|x, y| x.le(y))),
        ("gt", Box::new(|v| v), Box::new(|v| v.iter().map(|x| x + 1.0).collect()), 
            Box::new(|x, y| x.gt(y))),
        ("ge", Box::new(|v| v), Box::new(|v| v.iter().map(|x| x + 1.0).collect()), 
            Box::new(|x, y| x.ge(y))),
    ];
    ...
    let inplace_operations: Vec<(
        ...
        ("add_", Box::new(|v| v), Box::new(|v| v.iter().map(|x| x + 1.0).collect()), 
            Box::new(|x, y| x.add_(y))),
        ("sub_", Box::new(|v| v), Box::new(|v| v.iter().map(|x| x + 1.0).collect()), 
            Box::new(|x, y| x.sub_(y))),
        ("mul_", Box::new(|v| v), Box::new(|v| v.iter().map(|x| x + 1.0).collect()), 
            Box::new(|x, y| x.mul_(y))),
        ("div_", Box::new(|v| v.iter().map(|x| x + 2.0).collect()), 
            Box::new(|v| v.iter().map(|x| x + 1.0).collect()), 
